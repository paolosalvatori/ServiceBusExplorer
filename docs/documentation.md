...
<div style="text-align: center;"><img id="143452" src="img/servicebusexplorer.jpg" alt="" /></div>
<div></div>
...
<div style="text-align: center;"><img id="143380" src="img/disableentity.png" alt="" width="385" height="599" /></div>
<div>&nbsp;</div>
<ul>
...
<div style="text-align: center;"><img id="143381" src="img/filterform.png" alt="" width="459" height="562" /></div>
<div>&nbsp;</div>
<ul>
<li>Added support for Windows Azure Service Bus connection strings in the Connect Form. </li>
</ul>
<div style="text-align: center;"><img id="143382" src="img/connectionstring.png" alt="" width="469" height="668" /></div>
<div>&nbsp;</div>
<ul>
...
<div style="text-align: center;"><img id="143383" src="img/forwardform.png" alt="" width="562" height="563" /></div>
<div>&nbsp;</div>
<ul>
...
<div style="text-align: center;"><img id="143384" src="img/getmessagesessions.png" alt="" width="376" height="705" /></div>
<div>&nbsp;</div>
<ul>
...
<div style="text-align: center;"><img id="143385" src="img/authorizationrulestab.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143388" src="img/metricrootnode.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143389" src="img/metricsquerytab.png" alt="" width="800" /></div>
<div style="text-align: center;"><br /> <img id="143390" src="img/metricsmaingraph.png" alt="" width="800" /><br /> <img id="143391" src="img/singlemetricstab.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143392" src="img/metricsonentitytab.png" alt="" width="800" /></div>
<div style="text-align: center;"><img id="143393" src="img/metricsonentitytab2.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143394" src="img/monitortab.png" alt="" width="800" /></div>
<div>&nbsp;</div>
<ul>
...
<p style="text-align: center;"><img id="143406" src="img/sessions.png" alt="" width="800" /></p>
<div style="text-align: center;"></div>
<ul>
...
<div style="text-align: center;"><img id="143404" src="img/readmessages2.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143403" src="img/messages2.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143402" src="img/deadletter2.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143401" src="img/deadletter3.png" alt="" width="800" /></div>
<div>&nbsp;</div>
<ul>
...
<div style="text-align: center;"><img id="143400" src="img/repairandresubmit.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143407" src="img/senderthinktime.png" alt="" width="800" /></div>
<div>&nbsp;</div>
<ul>
...
<div style="text-align: center;"><img id="143408" src="img/receiverthinktime.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143409" src="img/messagefiles.png" alt="" width="800" /></div>
<ul>
...
<div style="text-align: center;"><img id="143410" src="img/optionsform.png" alt="" width="588" height="540" /></div>
<ul>
<li><strong>New About form</strong>: you can access my email address and twitter account in the new about form. </li>
</ul>
<div style="text-align: center;"><img id="143411" src="img/aboutform.png" alt="" width="652" height="532" /></div>
<ul>
...
<div style="text-align: center;"><img id="143412" src="img/autodelete2.png" alt="" width="800" /></div>
<ul>
...
<p style="text-align: center;"><img id="143413" src="img/connectivitymodetransporttype.png" alt="" width="452" height="746" /></p>
<ul>
...
<p style="text-align: center;"><img id="143414" src="img/connectivitymodeoptionsform.png" alt="" width="610" height="522" /></p>
<ul>
...
<p style="text-align: center;"><img id="143415" src="img/log.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143417" src="img/messagecountdetails.png" alt="" width="800" /></p>
<ul>
...
<p style="padding-left: 30px; text-align: center;"><img id="143418" src="img/repairsinglemessage.png" alt="" width="800" /></p>
...
<p style="padding-left: 30px; text-align: center;"><img id="143419" src="img/notificationhubs.png" alt="" width="448" height="243" /></p>
<ul>
...
<p style="text-align: center;"><img id="143420" src="img/newhub.png" alt="" width="800" /></p>
<ul>
<li>If you click an existing notification hub, you can view and edit credentials and metadata: </li>
</ul>
<p style="text-align: center;"><img id="143421" src="img/notificationhub01.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143422" src="img/authorizationrules.png" alt="" width="800" /></p>
<ul>
<li>The <strong>Registrations </strong>buttons opens a a dialof that allows the registrations to query: </li>
</ul>
<p style="text-align: center;"><img id="143423" src="img/getregistrations.png" alt="" width="450" height="226" /></p>
<ul>
...
<p style="text-align: center;"><img id="143424" src="img/registrations.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143425" src="img/createnewregistration.png" alt="" width="482" height="354" /></p>
<ul>
...
<p style="text-align: center;"><img id="143426" src="img/template.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143427" src="img/windowsphone.png" alt="" width="800" /></p>
<p style="text-align: center;"><img id="143428" src="img/windowsphonetile.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143429" src="img/windows2.png" alt="" width="800" /></p>
<p style="text-align: center;"><img id="143430" src="img/windows.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143431" src="img/gcm.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143433" src="img/resubmitmultiplemessages.png" alt="" width="800" /></p>
<ul>
<li><strong>Minor changes</strong> 
<ul>
...
<p style="text-align: center;"><img id="143434" src="img/messages.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143435" src="img/sessions2.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143436" src="img/registrations3.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143437" src="img/messages3.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143438" src="img/registrations4.png" alt="" width="800" /></p>
<ul>
</ul>
<ul>
...
<p style="text-align: center;"><img id="143439" src="img/tagexpression.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143440" src="img/partitionedqueue.png" alt="" width="800" /></p>
<ul>
<li>Introduced support for partitioned topics. For more information on partitioned entities, read <a href="http://blogs.msdn.com/b/windowsazure/archive/2013/10/29/partitioned-service-bus-queues-and-topics.aspx"> Partitioned Service Bus Queues and Topics</a>.&nbsp;This feature is available only in the Service Bus Explorer 2.2. </li>
</ul>
<p style="text-align: center;"><img id="143441" src="img/partitionedtopic.png" alt="" width="800" /></p>
...
<p style="text-align: center;"><img id="143442" src="img/microsoft.servicebus.connectionstring.png" alt="" width="452" height="746" /></p>
...
<p style="text-align: center;"><img id="143443" src="img/listener04.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143444" src="img/listener05.png" alt="" width="800" /></p>
<ul>
<li>Press the <strong>Start </strong>button to start the listener.&nbsp; </li>
</ul>
<p style="text-align: center;"><img id="143445" src="img/listener01.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143446" src="img/listener02.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143447" src="img/listener06.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="143448" src="img/listener03.png" alt="" width="800" /></p>
<ul>
<li>Minor changes: 
<ul>
...
<p style="text-align: center;"><img id="134454" src="img/relayservices01.png" alt="" width="372" height="570" /></p>
<ul>
...
<p style="text-align: center;"><img id="134456" src="img/relayservices02.png" alt="" width="800" /></p>
...
<p style="text-align: center;"><img id="134457" src="img/relayservices03.png" alt="" width="800" /></p>
...
<p style="text-align: center;"><img id="134458" src="img/relayservices04.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>Metric rule definition</strong></p>
<p style="text-align: center;"><strong><img id="134459" src="img/relayservices05.png" alt="" width="800" /><br /> </strong></p>
...
<p style="text-align: center;"><img id="134460" src="img/relayservices06.png" alt="" width="800" /></p>
<ul>
...
<p><img id="134452" src="img/relaymessage.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="134463" src="img/bytespersecond01.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>HandlePartitionControl</strong></p>
<p style="text-align: center;"><img id="134464" src="img/bytespersecond02.png" alt="" width="800" /></p>
...
<p style="text-align: center;"><img id="134480" src="img/startingdatetimeutc01.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>Consumer Group / Partition Listener: Listener Tab</strong></p>
<p style="text-align: center;"><img id="134481" src="img/startingdatetimeutc02.png" alt="" width="800" /></p>
...
<p style="text-align: center;"><img id="134461" src="img/partitionlistenercontrol01.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>Consumer Group / Partition Listener</strong></p>
<ul>
...
<p style="text-align: center;"><img id="134467" src="img/allmetric.png" alt="" width="800" /></p>
<ul>
...
<p style="text-align: center;"><img id="134468" src="img/eventhubmetrics01.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>Event Hub: metric rule definition</strong></p>
<p style="text-align: center;"><img id="134469" src="img/eventhubmetrics02.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>Event Hub: metric data and charts</strong></p>
<p style="text-align: center;"><strong><img id="134470" src="img/consumergroupmetrics01.png" alt="" width="800" /><br /> </strong></p>
<p style="text-align: center;"><strong>Consumer Group: metric rule definition</strong></p>
<p style="text-align: center;"><img id="134471" src="img/consumergroupmetrics02.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>Consumer Group:&nbsp;&nbsp;metric data and charts</strong></p>
<p style="text-align: center;"><img id="134472" src="img/notificationhubmetrics01.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>Notification Hub:&nbsp;<strong>metric rule definition</strong></strong></p>
<p style="text-align: center;"><img id="134473" src="img/notificationhubmetrics02.png" alt="" width="800" /></p>
...
<p style="text-align: center;"><img id="134474" src="img/relaymetrics01.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>Relay:&nbsp;<strong>metric rule definition</strong></strong></p>
<p style="text-align: center;">&nbsp;<img id="134475" src="img/relaymetrics02.png" alt="" width="800" /></p>
...
<p style="text-align: center;"><img id="134476" src="img/namespacemetrics01.png" alt="" width="800" /></p>
<p style="text-align: center;"><strong>Namespace:&nbsp;<strong>metric rule definition</strong></strong></p>
<p style="text-align: center;"><img id="134477" src="img/namespacemetrics02.png" alt="" width="800" /></p>
...
<p style="text-align: center;"><img id="134518" src="img/peekmessages.png" alt="" width="480" height="256" /></p>
...
<p>&nbsp;</p>
<p style="text-align: center;"><img id="143449" src="img/menuitem.png" alt="" width="369" height="257" /></p>
<p style="text-align: center;">&nbsp;</p>
<p style="text-align: center;"><img id="143450" src="img/button.png" alt="" width="800" /></p>
...
<p><img id="143299" src="img/iothublistener.png" alt="" width="512" height="205" /></p>
<p><img id="143300" src="img/parameters.png" alt="" width="616" height="225" /></p>
<p><img id="143301" src="img/sbe02.png" alt="" width="800" /></p>
