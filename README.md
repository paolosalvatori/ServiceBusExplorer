...
### Cached credentials
The logged in user credentials is cached. In some scenarios it may be neccessary to log out from Entra to switch user. Use the menu item Log out from Entra for that. 
