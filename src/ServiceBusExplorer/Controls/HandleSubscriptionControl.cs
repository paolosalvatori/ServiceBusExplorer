...
namespace ServiceBusExplorer.Controls
{
    public partial class HandleSubscriptionControl : UserControl
    {
        ...
        private string messagesBodyFreeTextFilter;
        private string messagesBodyJsonPath;
        private string messagesBodyJsonValue;
        private bool messagesBodyCaseSensitive;
        private string deadletterBodyFreeTextFilter;
        private string deadletterBodyJsonPath;
        private string deadletterBodyJsonValue;
        ...
        private string deadletterReasonFilter;
            ...
            try
            {
                ...
                if (peek)
                {
                    ...
                    while (all || totalRetrieved < count)
                    {
                        ...
                        {
                            messageEnumerable = subscriptionClient.PeekBatch(fromSequenceNumber.Value, batchSize);
                        }
                        else
                        {
                            messageEnumerable = subscriptionClient.PeekBatch(batchSize);
                        }
